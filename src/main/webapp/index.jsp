...
<body>
	...
	<table>
		...
		<tr>
			...
			<td>
				<a href="single-product?id=<%= user.getId()%>">CHI TIET</a>
			</td>
		</tr>
		<% } %>
	</table>
	...
	<div class="copyright">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<p>Copyrights &copy; <%= new java.text.SimpleDateFormat("yyyy").format(new java.util.Date()) %> - <a href="https://imransdesign.com/">Imran Hossain</a>,  All Rights Reserved.</p>
				</div>
